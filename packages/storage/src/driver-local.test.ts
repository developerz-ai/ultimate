// Single responsibility: what the local disk driver DOES with objects — put, get, stream, list,
// copy, delete, signedUrl — against a real temporary directory, sidecar and all. What it refuses
