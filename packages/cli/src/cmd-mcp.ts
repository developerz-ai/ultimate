// `x mcp serve` — the framework's dev MCP server over stdio or HTTP. The 17 tools, the JSON-RPC
 ...
 * transport carries JSON-RPC frames, and `✓ mcp stdio serving 17 tools` arriving on it after the
