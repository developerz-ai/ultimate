...
// and the sweep that empties the tables it fills. `runtime-purge.test.ts` proves the wiring with stubs
...
//     bun test packages/cli/src/runtime-purge.live.test.ts
...
describeLive('live · postgres · what the boot installs for auth and retention', () => {
  ...
  // The whole reason this file exists, applied to the two newest targets: `runtime-purge.test.ts`
