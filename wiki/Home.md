...
**`As of 2026-08`.** 29 `@ultimat3/*` packages plus the unscoped `create-ultimate` — 30 in all — version in lockstep at **2.0.0**, the first major: 33 changelog entries are marked `BREAKING —` and none ships a codemod ([Upgrading](Upgrading)).
