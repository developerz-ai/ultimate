...
Realtime tier 3 (local-first) has **not shipped**, `As of 2026-08`. `persist` is not a field a `query()` accepts yet — writing it is a `TS2353` excess property, not a runtime refusal.
